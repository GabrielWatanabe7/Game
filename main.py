...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image_run = [pygame.image.load('assets/Run__000.png').convert_alpha(),
                          pygame.image.load('assets/Run__001.png').convert_alpha(),
                          pygame.image.load('assets/Run__002.png').convert_alpha(),
                          pygame.image.load('assets/Run__003.png').convert_alpha(),
                          pygame.image.load('assets/Run__004.png').convert_alpha(),
                          pygame.image.load('assets/Run__005.png').convert_alpha(),
                          pygame.image.load('assets/Run__006.png').convert_alpha(),
                          pygame.image.load('assets/Run__007.png').convert_alpha(),
                          pygame.image.load('assets/Run__008.png').convert_alpha(),
                          pygame.image.load('assets/Run__009.png').convert_alpha(),
                          ]
        self.image_fall = pygame.image.load('assets/Fall.png').convert_alpha()
        self.image = pygame.image.load('assets/Run__000.png').convert_alpha()
    ...
    def update(self, *args):
        ...
        def fly(self):
            ...
            if key[pygame.K_SPACE]:
                self.rect[1] -= 30
                self.image = pygame.image.load('assets/Fly.png').convert_alpha()
                self.image = pygame.transform.scale(self.image, [100, 100])
                print('fly')
        fly(self)
...
BACKGROUND = pygame.image.load('assets/background_03.jpg')
...
while gameloop:
    ...
    contador = font.render(f'{score}', True, [255,255,255])
